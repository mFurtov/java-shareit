...
public class BookingController {
    ...
    @GetMapping
    public List<BookingDto> getBookingWithStatus(@RequestHeader(HeaderConstants.X_SHARER_USER_ID) int userId, @RequestParam(defaultValue = "ALL") String state, @RequestParam(defaultValue = "0") int from, @RequestParam(defaultValue = "10") Integer size) {
    ...
    @GetMapping("/owner")
    public List<BookingDto> getBookingWithStatusOwner(@RequestHeader(HeaderConstants.X_SHARER_USER_ID) int userId, @RequestParam(defaultValue = "ALL") String state, @RequestParam(defaultValue = "0") int from, @RequestParam(defaultValue = "10") Integer size) {
